...
fill_form_text = {
    ...
    'underframe': 'Выберите подстолье или пропустите этот шаг, нажав кнопку «Без подстолья»',
...
📷Фотографии заказчика.
    ''',
    2: '''
    Тумба для виниловых пластинок по чертежам клиента💿
...
📷Фотографии заказчика.
    ''',
    5: '''
    Заказ для заведения «Кебаб-Хана»🌯

▪Барная стойка
▪Материал: сосна
▪Покрытие: масло-воск цвета «Махагон»
...
▪Столешница: сосна
▪Размеры: 1800х800х40
▪Покрытие: масло-воск в два слоя
▪Цвет: «Коньяк»

📷Фотографии заказчика.
    ''',
    7: '''
    Индивидуальный заказ и пожелание клиента — полочка в ванную комнату🛁
